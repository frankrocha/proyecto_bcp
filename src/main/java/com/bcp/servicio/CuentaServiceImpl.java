...
public class CuentaServiceImpl implements CuentaService{
	...
	@Override
	public Cuenta listaCuentaPorNumero2(String numero) {
		
		return repository.listaCuentaPorNumero2(numero);
	}

	
	@Override
	public Cuenta listaCuentaPorIdCuenta(int id) {

		return repository.listaCuentaPorIdCuenta(id);
	}
