...
public interface CuentaRepository  extends JpaRepository<Cuenta, Integer>{
	...
	@Query("select x from Cuenta x where x.numero like :var_parm")
	public abstract Cuenta listaCuentaPorNumero2(@Param("var_parm") String numero);
	
	@Query("select x from Cuenta x where x.idCuenta = :var_parm")
	public abstract Cuenta listaCuentaPorIdCuenta(@Param("var_parm") int id);
